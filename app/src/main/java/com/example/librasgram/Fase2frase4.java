...
public class Fase2frase4 extends AppCompatActivity {

    private Vibrator vibrator;

    private String frase = "o lápis está em cima da mesa!";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fase2frase4);
        ...
        konfettiView = findViewById(R.id.konfettiView8);
        ...
        campoResposta = findViewById(R.id.tela8campoResposta);
    ...
    public void showDialogVoltar(View view){
        Dialog dialog = new Dialog(Fase2frase4.this);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent t = new Intent(Fase2frase4.this, Fase2frase3.class);
    ...
    public void showDialogProximo(View view){
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent t = new Intent(Fase2frase4.this, Pontuacao.class);
