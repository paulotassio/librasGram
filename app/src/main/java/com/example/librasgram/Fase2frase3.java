...
public class Fase2frase3 extends AppCompatActivity {

    private Vibrator vibrator;

    private String frase = "a caneta está com a tampa quebrada!";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fase2frase3);
        ...
        konfettiView = findViewById(R.id.konfettiView7);
    ...
    public void showDialogVoltar(View view){
        Dialog dialog = new Dialog(Fase2frase3.this);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent t = new Intent(Fase2frase3.this, Fase2frase2.class);
                t.putExtra("pontos", pontuacao-125);
                t.putExtra("erros", erros);startActivity(t);
                dialog.dismiss(); // Fecha o pop-up
    ...
    public void showDialogProximo(View view){
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent t = new Intent(Fase2frase3.this, Fase2frase4.class);
