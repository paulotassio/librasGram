...
public class Fase2frase1 extends AppCompatActivity {

    private Vibrator vibrator;

    private String frase = "eu vou para a escola!";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fase2frase1);
    ...
    public void showDialogVoltar(View view){
        Dialog dialog = new Dialog(Fase2frase1.this);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent t = new Intent(Fase2frase1.this, Fase1frase4.class);
    ...
    public void showDialogProximo(View view){
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent t = new Intent(Fase2frase1.this, Fase2frase2.class);
